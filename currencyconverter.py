...
class CurrencyConverter:  # Create class
    def __init__(self):  # Special method in Python class
        ...
        window.configure(bg="purple")   # Add background color to application window
        ...
        Label(window,font="Helvetica 12 bold",bg="purple",text ="Conversion Rate").grid(row=2, column=1,sticky =W)
        Label(window,font="Helvetica 12 bold",bg="purple",text ="Converted Amount").grid(row=3, column=1,sticky =W)
